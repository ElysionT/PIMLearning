 ...
 */
public class ContactLoader extends DetailLoader<Contact> {
    ...
    public Contact loadInBackground() {
        try {
            ...
            final Uri uriCurrentFormat = ensureIsContactUri(
                    resolver, mLookupUri);
            ...
            if (cachedResult != null &&
                    areEqual(cachedResult.getLookupUri(), mLookupUri)) {
                ...
                if (uriCurrentFormat.getLastPathSegment().equals(ContactsConstants.LOOKUP_URI_ENCODED)) {
    ...
    public static Uri ensureIsContactUri(final ContentResolver resolver, final Uri uri)
        ...
        if (ContactsContract.AUTHORITY.equals(authority)) {
            ...
            if (ContactsContract.RawContacts.CONTENT_ITEM_TYPE.equals(type)) {
                ...
                return ContactsContract.RawContacts.getContactLookupUri(resolver,
