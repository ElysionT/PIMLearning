 ...
 * a read-only object.
 */
public class Contact extends DetailData {
...
//    }
    ...
    public String toString() {
        return "{" +
                "mRequestedUri=" + mRequestedUri +
                "\n mLookupUri=" + mLookupKey +
                "\n mUri=" + mUri +
                "\n status=" + mStatus +
                "\n mDirectoryId=" + mDirectoryId +
                "\n mLookupKey=" + mLookupKey +
                "\n mId=" + mId +
                "\n mNameRawContactId=" + mNameRawContactId +
                "\n mDisplayNameSource=" + mDisplayNameSource +
                "\n mPhotoId=" + mPhotoId +
                "\n mPhotoUri=" + mPhotoUri +
                "\n mDisplayName=" + mDisplayName +
                "\n mAltDisplayName=" + mAltDisplayName +
                "\n mPhoneticName=" + mPhoneticName +
                "\n mStarred=" + mStarred +
                "\n mPresence=" + mPresence +
                "}";
    }
